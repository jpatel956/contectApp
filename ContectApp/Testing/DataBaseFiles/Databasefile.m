...
static Databasefile *shareDatabase =nil;
...
+(Databasefile*) shareDatabase{
	...
	if(!shareDatabase){
		shareDatabase = [[Databasefile alloc] init];
	}
...
NSString * const DataBaseName  = @"datastore.sqlite3"; // Paas Your DataBase Name Over here
